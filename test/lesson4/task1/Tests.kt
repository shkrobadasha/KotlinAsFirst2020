...
class Tests {
    ...
    @Tag("3")
    fun factorize() {
        assertEquals(listOf(3, 119267), factorize(357801))
    ...
    fun factorizeToString() {
        assertEquals("2*2*2*3*5*6091", factorizeToString(730920))
    ...
    @Tag("7")
    fun russian() {
        assertEquals("триста двадцать одна тысяча триста семьдесят пять", russian(321375))
        ...
        assertEquals("девятьсот тысяч один", russian(900001))
